...
//    lastly (fun _ -> portalLogout ())
    ...
    "Navigate to nsc Home Page" &&&& fun _ ->
        url ("http://www.studentclearinghouse.org/") 
        displayed "User Login"
        highlight "User Login"
        highlight "#menu > li.nava > a"
        hover "#menu > li.nava > a"
        highlight "#menu > li.nava > div > div.menu-a-col1 > p:nth-child(1) > a"
        click "#menu > li.nava > div > div.menu-a-col1 > p:nth-child(1) > a"
        displayed "What We Do"
        highlight "What We Do"
        click "body > div.masthead > div.mainlogo > a > img"

        hover "#menu > li.nava > a"
        highlight "#menu > li.nava > div > div.menu-a-col1 > p:nth-child(2) > a"
        click "#menu > li.nava > div > div.menu-a-col1 > p:nth-child(2) > a"
        displayed "Who We Work With"
        highlight "Who We Work With"
        click "body > div.masthead > div.mainlogo > a > img"

        hover "#menu > li.nava > a"
        highlight "#menu > li.nava > div > div.menu-a-col1 > p:nth-child(3) > a"
        click "#menu > li.nava > div > div.menu-a-col1 > p:nth-child(3) > a"
        displayed "Our History"
        highlight "Our History"
        click "body > div.masthead > div.mainlogo > a > img"

        hover "#menu > li.nava > a"
        highlight "#menu > li.nava > div > div.menu-a-col1 > p:nth-child(4) > a"


        highlight "#menu > li.nava > div > div.menu-a-col1 > p:nth-child(5) > a"


        highlight "#menu > li.nava > div > div.menu-a-col1 > p:nth-child(5) > a"


        highlight "#menu > li.nava > div > div.menu-a-col2 > p:nth-child(1) > a"


        highlight "#menu > li.nava > div > div.menu-a-col2 > p:nth-child(2) > a"


        highlight "#menu > li.nava > div > div.menu-a-col2 > p:nth-child(3) > a"


        highlight "#menu > li.nava > div > div.menu-a-col2 > p:nth-child(4) > a"


        highlight "#menu > li.nava > div > div.menu-a-col2 > p:nth-child(5) > a"

        hover "#menu > li.navc > a"
        highlight "#menu > li.navc > a"
        click "#menu > li.navc > div > div > p.no-brdr.ext-link > a"
        switchToTab 2
        displayed "What is the Clearinghouse K-20 exchange solution?"
        press Keys.End
        displayed "©2018 National Student Clearinghouse. All Rights Reserved."
        browser.Close()
        //browser.Close()
        sleep 5
