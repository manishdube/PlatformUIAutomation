module VolunteerChangeUsernamePassword_22115
open canopy
open runner
open etconfig
open lib
...
let core _ = 
    context "VolunteerChangeUsernamePassword_22115"
    compareTimeout <- 30.0
    once (fun _ -> portalLogin ())
    lastly (fun _ -> portalLogout ())

    let userName1 = getRandomString (20)
    let firstName1 = userName1.[0..9]
    let lastName1 = userName1.[5..18]
    ...
    let userName2 = getRandomString (20)
    let firstName2 = userName2.[0..18]
    let lastName2 = userName2.[5..16]
...
//        containsInsensitive lastName1 (read "#ddlCoordinator")
        ...
        "#tbLogID" << "changedUserName"
        "#tbPassword" << "changedPassword"
...
//    "assert new values on the Volunteer Details page" &&&& fun _ ->
        ...
        containsInsensitive "changedUserName" (read "#tbLogID")
        containsInsensitive "changedPassword" (read "#tbPassword")
        describe "done ..."
