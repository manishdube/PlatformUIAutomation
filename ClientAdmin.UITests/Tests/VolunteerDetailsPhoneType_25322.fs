module VolunteerDetailsPhoneType_25322
open canopy
open runner
open etconfig
open lib
...
let core _ = 
    context "VolunteerDetailsPhoneType_25322"
    compareTimeout <- 30.0
...
//        containsInsensitive lastName1 (read "#ddlCoordinator")
        ...
        "#ctl00_MainContent_FormView2_tbPhone1" << phone1
        click "#ctl00_MainContent_FormView2_MyToggleSwitch1_Checkbox"
        "#ctl00_MainContent_FormView2_tbPhone2" << phone2
        "#ctl00_MainContent_FormView2_tbPhone3" << phone3
...
//    "assert new values on the Volunteer Details page" &&&& fun _ ->
        ...
        containsInsensitive iVolPwd (read "#tbPassword")
        containsInsensitive phone1 (read "#ctl00_MainContent_FormView1_Label3")
        containsInsensitive phone2 (read "#ctl00_MainContent_FormView1_Label5")
        containsInsensitive phone3 (read "#ctl00_MainContent_FormView1_Label7")
        describe "done ..."
